...
| **M5** | Product shell | hotkey, capsule, settings, history |
| **M6** | Edit learning UX | pre-insert edit + confirm promote; optional post-paste AX |

See [PRODUCT.md](../PRODUCT.md) for full scope.
